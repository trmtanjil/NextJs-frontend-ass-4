...
const reviews = [
  { id: 1, name: "Tanjil Ahmed", role: "Student", comment: "The medicare process was so smooth and easy!", rating: 5 },
  { id: 2, name: "Sakib Khan", role: "Applicant", comment: "Found my dream product through this platform.", rating: 4 },
  { id: 3, name: "Anika Tabassum", role: "Student", comment: "Highly recommended for all customer.", rating: 5 },
  { id: 4, name: "Rahat Karim", role: "Scholar", comment: "Best UI and user experience I've ever seen.", rating: 5 },
  { id: 5, name: "Nusrat Jahan", role: "Student", comment: "Got a full fund product in this web site!", rating: 4 },
  ...
  { id: 8, name: "Imran Hossain", role: "Student", comment: "Finally, a reliable medicare portal for us.", rating: 4 },
  { id: 9, name: "Sadiya Afrin", role: "Scholar", comment: "Great platform to manage all my customer.", rating: 5 },
  ...
  return (
    <div className="py-20 bg-slate-50 overflow-hidden space-y-10">
      <div className="text-center mb-10">
        <h2 className="text-3xl font-bold text-slate-900">What Our Customer Say</h2>
        <p className="text-slate-500 mt-2">Trusted by thousands of Customer worldwide</p>
      </div>
